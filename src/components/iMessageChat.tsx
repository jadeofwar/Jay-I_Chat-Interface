...
export const IMessageChat = ({ webhookUrl }: iMessageChatProps) => {
      ...
      <div className="imessage-header">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-500">Family Assistant</p>
          </div>
          <Button
            variant="ghost"
            size="sm"
      ...
      <div className="imessage-body">
        <div className="messages-container">
          {messages.map((message) => (
            <div
              key={message.id}
              className={`message-wrapper ${message.isUser ? 'user-message' : 'assistant-message'}`}
            >
